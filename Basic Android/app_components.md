- App Component are Essential `Building blocks` of android. Each component are `starting` or `entry point` through which the system or user can enter the app.Some component `depends` on others.
